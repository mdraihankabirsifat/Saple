-- CONSOLIDATED DEMONSTRATION DATA.
-- THE CURRENT SAPLE DATABASE IS ALREADY POPULATED.
-- DO NOT EXECUTE THIS FILE AGAIN UNLESS REBUILDING A COMPLETELY FRESH DATABASE.

-- This presentation file preserves the historical data scripts in execution order.
-- ================================================================
-- SOURCE 1: database/sql/03_data/03_insert_sample_data.sql
-- ================================================================
...
-- ================================================================
-- SOURCE 2: database/sql/03_data/05_expand_reference_data.sql
-- ================================================================
...
COMMIT;
-- ================================================================
-- SOURCE 3: database/sql/03_data/08_seed_demo_salary_reviews.sql
-- ================================================================
